...
void Texture::Draw( const Point2f& dstBottomLeft, const Rectf& srcRect, const Color4f& color ) const
{
	if ( !m_CreationOk )
	{
	...
	else
	{
		...
		Draw( destRect, srcRect, color );
	}
}

void Texture::Draw( const Rectf& destRect, const Rectf& srcRect, const Color4f& color ) const
{
	if ( !m_CreationOk )
	{
