...
public:
	...
	void Draw( const Point2f& destBottomLeft = {}, const Rectf& srcRect = {}, const Color4f& color = Color4f(1,1,1,1) ) const;
	void Draw( const Rectf& destRect, const Rectf& srcRect = {}, const Color4f& color = Color4f(1,1,1,1) ) const;
